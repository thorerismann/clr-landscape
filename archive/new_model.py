...
cluster = [0.2,0.35,0.5] # cluster value ranging from 0-1 for neutral landscape model
proportions = [0.2,0.35,0.5] # proportion of values in each category (0,1 coffee not coffee)
